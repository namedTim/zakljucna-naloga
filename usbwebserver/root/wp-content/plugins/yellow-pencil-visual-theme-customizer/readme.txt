...
* Anymore CSS Editor doesn't reorder css rules when adding an new rule.
* The plugin has been made more useful with little touches.

= 7.1.3 =
* New Feature: Stock Images (Unsplash API)
* New Feature: Page Assets (Shows all images in page in Design information Tool)
* New Feature: Draft Mode
* improvements to editor loading performance.
* Login Page font load bug fixed.
* CSS Editor AutoComplete bug fixed.
