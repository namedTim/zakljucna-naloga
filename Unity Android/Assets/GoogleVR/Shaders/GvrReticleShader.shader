...
Shader "GoogleVR/Reticle" {
  Properties {
    ...
    _InnerDiameter ("InnerDiameter", Range(0, 10.0)) = 1.5 //1.5 default value
    _OuterDiameter ("OuterDiameter", Range(0.00872665, 10.0)) = 2.0 //2.0
    _DistanceInMeters ("DistanceInMeters", Range(0.0, 100.0)) = 2.0 //2.0
  }
