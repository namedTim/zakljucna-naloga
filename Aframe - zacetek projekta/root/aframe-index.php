...
<html>
  ...
  <body>
    ...
    <a-entity id="link" class="icon0" layout="type: line; margin: 1.5" position="-5.853 -3.859 0.139" rotation="-40 95.49 0">
      ...
      <a-sky src="/images/test.png" radius="9,5" phi-start="160" id = "image-360"></a-sky>
      </a-entity>
...
<a-image id="mikro-text" rotation="0 26.8 0" position="-4.327 -1.843 -7.613" geometry="height:3.43;width:4.72" material="" src="/images/text/microplasma-text.jpg"></a-image>
      </a-entity>
      ...
      <a-entity position="-5.603 1.577 -6.809" rotation="0 55.22 0" text="value:Gonoreja;color:rgb(51, 204, 255);height:2.31;letterSpacing:2.02;lineHeight:1.76;opacity:1.19;tabSize:5.51;width:6.31"></a-entity><a-sky src="/images/gonoreja.jpg" radius="10" id = "image-360"></a-sky>     
...
<a-image id="sifilis-text" rotation="0 0.6199999999999997 0" position="0.544 -1.133 -8.666" geometry="height:3.43;width:4.72" material="" src="/images/text/Sipilis-text.jpg"></a-image>
     </a-entity>
      ...
      <a-image id="klamidija-text" rotation="-5.73 -22.45999999999999 0" position="3.415 -0.448 -5.675" geometry="height:3.43;width:4.72" material="" src="/images/text/klamidija-text.jpg"></a-image>
      </a-entity>
...
<a-sky src="/images/hiv3.jpg" radius="10" id = "image-360"></a-sky>
<a-image id="hiv-text" rotation="0 -60.04999999999999 0" position="6.547 -0.24 -3.462" geometry="height:3.4299999999999997;width:4.720000000000001" material="" src="/images/text/hiv-text.jpg"></a-image>
...
<a-sky src="/images/papiloma.jpg" radius="10" id = "image-360"></a-sky>
      ...
      <a-image id="herpes-text" rotation="0 -109.69 0" position="7.044 -0.234 3.516" geometry="height:3.63;width:4.53" material="" src="/images/text/herpes-text.jpg"></a-image>
      </a-entity>
